...
var formatFunctions_exports = {};
__export(formatFunctions_exports, {
  formatOrder: () => formatOrder
});
module.exports = __toCommonJS(formatFunctions_exports);
const formatOrder = (data) => {
  console.log("Reply form slack: ", data);
  const formatedOrder = { user: data.user, orderInfo: {} };
